...
sed -i  "s|<js_async></js_async>|<script src=\"/static/js/$main_js\"></script>|"  build/index.html;
...
sed -i  "s|<css_async></css_async>|<link href=\"/static/css/$main_css\" rel=\"stylesheet\">|"                  build/index.html;
